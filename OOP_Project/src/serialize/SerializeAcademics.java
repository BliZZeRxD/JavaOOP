...
public class SerializeAcademics 
{
    ...
    public void addCourseFileToByte(String courseFileId, CourseFile courseFile)
    {
        try 
        {  
            FileOutputStream file = new FileOutputStream (courseFileId+".txt");;
            ObjectOutputStream out = new ObjectOutputStream (file);          
            out.writeObject(courseFile);
            out.close(); 
            file.close();
            System.out.println("course file with id: "+courseFileId+" was successfully added");
        }
        catch (IOException ex) 
        { 
            System.out.println("course file adding is failed"); 
        }
    }
    
    public void removeCourseFileToByte(String id)
    {
        File newFile = new File(id+".txt");
        boolean deleted = newFile.delete();
        if(deleted)
        System.out.println("course file with "+id+" was successfully deleted");
    }
    
    public CourseFile viewCourseFileToByte(String id)
    {
