    ...
    public Person addUser(Scanner scanner)
    {
        ...
        switch(userPosition)
        {
            case 1:
            {
                ...
                String adminWorkMode = scanner.nextLine();
                ...
                String adminAccessType = scanner.nextLine();
            ...
            case 2:
            {
                ...
                String managerWorkMode = scanner.nextLine();
            ...
            case 4:
            {
                ...
                String teacherWorkMode = scanner.nextLine();
                ...
                String teacherCourseName = scanner.nextLine();
            ...
            case 5:
            {
                ...
                String laWorkMode = scanner.nextLine();
            ...
            default:
            {
                ...
                String studentPaymentMode = scanner.nextLine();
